...
parser.add_argument("-i", "--identity", default=90, type=int,
...
if args.extended:
    ...
    Verbose = False
if args.all:
    GAMMA_All_Out(args.input_fasta, args.db, args.output,  args.identity, Verbose)
else:
    GAMMA_Out(args.input_fasta, args.db, args.output,  args.identity, Verbose)
if args.fasta:
